...
const BestSell = () => {
    return (
        <div className="hero max-h-fit lg:pb-48 lg:mb-60 bg-pink-50">
     ...
     data-aos-duration="1500"/>
          ...
          <div className='w-1/2 lg:ml-20'>
            <h1 className="lg:text-5xl font-bold mt-32" style={{ fontFamily: 'Libre Baskerville', color:'#965a3e' }}>See Our Top Selling  <span className='my-5 text-pink-400'> Products!</span> </h1>
            <h1 className="lg:text-5xl mt-5 text-gray-700 font-semibold">Happy Shoping With Us!!</h1>
